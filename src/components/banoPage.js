...
const BanoPage=()=>{
 ...
 const [articulo, setArticulos] = useState([]);
  ...
  const buscarArticulos = async () => {
    let resultado = await firebaseBuscar('articulosBan');
    debugger;
...
<div id="cardcss">
    ...
    <CardActionArea>
      ...
      <CardContent>
        ...
        <Button type='button' variant='contained' color='primary' id="comprar" onClick={() => elimina('articulosBan', customer.id)}>Comprar</Button>
        <Button  />
      </CardContent>
    </CardActionArea>
  </Card>
