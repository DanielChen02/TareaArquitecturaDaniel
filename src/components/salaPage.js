...
const SalaPage=()=>{
 ...
 const [articulo, setArticulos] = useState([]);
  ...
  const buscarArticulos = async () => {
    let resultado = await firebaseBuscar('articulosSala');
    debugger;
...
<div id="cardcss">
    ...
    <CardActionArea>
      ...
      <CardContent>
        ...
        <Button type='button' variant='contained' color='primary' id="comprar" onClick={() => elimina('articulosSala', customer.id)}>Comprar</Button>
        <Button  />
      </CardContent>
    </CardActionArea>
  </Card>
