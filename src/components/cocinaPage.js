...
const CocinaPage=()=>{
 ...
 const [articulo, setArticulos] = useState([]);
  ...
  const buscarArticulos = async () => {
    let resultado = await firebaseBuscar('articulosCoci');
    debugger;
...
<div id="cardcss">
    ...
    <CardActionArea>
      ...
      <CardContent>
        ...
        <Button type='button' variant='contained' color='primary' id="comprar" onClick={() => elimina('articulosCoci', customer.id)}>Comprar</Button>
        <Button  />
      </CardContent>
    </CardActionArea>
  </Card>
