...
const ComedorPage=()=>{
 ...
 const [articulo, setArticulos] = useState([]);
  ...
  const buscarArticulos = async () => {
    let resultado = await firebaseBuscar('articulosCome');
    debugger;
...
<div id="cardcss">
    ...
    <CardActionArea>
      ...
      <CardContent>
        ...
        <Button type='button' variant='contained' color='primary' id="comprar" onClick={() => elimina('articulosCome', customer.id)}>Comprar</Button>
        <Button  />
      </CardContent>
    </CardActionArea>
  </Card>
